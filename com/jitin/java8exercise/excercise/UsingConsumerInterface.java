...
public class UsingConsumerInterface {
	...
	private static void printConditionally(List<Employee> employees, Predicate<Employee> predicate, Consumer<Employee> consumer) {
	...
	public static void main(String[] args) {
		...
		//printAll(employees);
		printConditionally(employees,emp->true,emp->System.out.println(emp));
		System.out.println("\nName starts with G");
		printConditionally(employees, emp -> emp.getName().startsWith("G"),emp->System.out.println(emp.getId()+" : "+emp.getName()));
		System.out.println("\nName starts with R");
		printConditionally(employees, emp -> emp.getName().startsWith("R"),emp->System.out.println(emp.getName()));
		System.out.println("\nSalary greater than 35000");
		printConditionally(employees, emp -> emp.getSalary() > 35000,emp->System.out.println(emp.getName()+" : "+emp.getSalary()));
	}
}
